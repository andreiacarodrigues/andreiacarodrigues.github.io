<button onclick="goToTop()" id="top-btn" title="Go to top"><i class="fa fa-caret-up"></i></button>
        ...
        <div id="skills-list">
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="row">
                        <div class="list">
                            <h3> <i class="fa fa-file-code-o"></i> Programming Languages</h3>
                            <ul>
                                <li>C, C++, C#</li>
                                ...
                                <li>XML</li>
                                <li>HTML</li>
                                <li>CSS (frameworks: Bootstrap, Smarty)</li>
                                <li>HTTP</li>
                                <li>Regex</li>
                                <li>XPath</li>
                                <li>LaTex</li>
                    ...
                    <div class="row">
                        <div class="list">
                            ...
                            <ul>
                                ...
                                <li>Web Storm</li>
                                <li>Unity 3D</li>
                                <li>SICStus Prolog, SWI Prolog</li>
                            </ul>
                        </div>
                    </div>
                </div>
